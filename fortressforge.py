...
ttk.Label(root, text="Path to srcds_win64.exe*:").grid(row=0, column=0, padx=10, pady=5, sticky="e")
...
# Server Password
ttk.Label(root, text="Password:").grid(row=4, column=0, padx=10, pady=5, sticky="e")
